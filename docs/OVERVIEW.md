...
- **[MCP Primitives](./MCP-PRIMITIVES.md)** - Tools, resources, prompts reference
- **[Agent Compatibility](./AGENT-COMPATIBILITY.md)** - Platform-specific guides
...
**Next Steps:** Read the [Rules Engine](./RULES.md) documentation to understand the Rules layer in detail, or try the [Quick Start Guide](./QUICKSTART.md) to get hands-on immediately.
